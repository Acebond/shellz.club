...
{% include image.html url="/images/2021/03/image.png" description="" %}
...
{% include image.html url="/images/2021/03/image-1.png" description="Add a new machine account directly through an LDAP add request to a domain controller" %}
...
{% include image.html url="/images/2021/03/image-2.png" description="Configure RBCD on HEADHUNTER to allow ATTACKER1 delegation rights" %}
...
{% include image.html url="/images/2021/03/image-7.png" description="Calculate the Kerberos encryption keys using the username/password" %}
...
{% include image.html url="/images/2021/04/image.png" description="Rubeus s4u action using the aes256 hash" %}
...
{% include image.html url="/images/2021/03/image-6.png" description="Lateral movement with WMI" %}
