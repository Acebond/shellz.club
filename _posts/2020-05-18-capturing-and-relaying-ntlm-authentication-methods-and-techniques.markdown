...
{% include image.html url="/images/2020/05/image.png" description="" %}
...
{% include image.html url="/images/2020/11/image-1.png" description="Example Secure Configuration (NTLM authentication can only be performed to a single legacy system)" %}
